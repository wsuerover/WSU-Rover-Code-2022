...
def keyboard_controller(user_data):
	...
	if 'w' in keys_pressed:
		motorTargetVels[0] = pwmMap(0.5)
		motorTargetVels[1] = pwmMap(0.5)
		motorTargetVels[2] = pwmMap(0.5)
		motorTargetVels[3] = pwmMap(0.5)
		motorTargetVels[4] = pwmMap(0.5)
		motorTargetVels[5] = pwmMap(0.5)
...
def updateMotorData(event):	
	...
	data_out.rb_fr = motorVels[0]
	data_out.rb_mr = motorVels[1]
	data_out.rb_rr = motorVels[2]
	data_out.rb_fl = motorVels[3]
	data_out.rb_ml = motorVels[4]
	data_out.rb_rl = motorVels[5]	
