...
image1 = pygame.image.load("/home/ds332a/rover_code/src/rover_pkg/src/gui_recources/no_file_loaded.jpeg")
image1raw = pygame.image.load("/home/ds332a/rover_code/src/rover_pkg/src/gui_recources/no_file_loaded.jpeg")

image2 = pygame.image.load("/home/ds332a/rover_code/src/rover_pkg/src/gui_recources/filler.jpeg")
image2raw = pygame.image.load("/home/ds332a/rover_code/src/rover_pkg/src/gui_recources/filler.jpeg")
...
if __name__ == '__main__':
	...
	captureImageButton = Button(0.65, 0.5, 0.1, 0.05, "Capture Image")
	...
	while running:
		...
		while captureImageMode:		
			...
			if saveImageButton.handle(screen, width, height, font, mousePos, clicked):
				...
				pygame.image.save(rawImages[selectedImage],'/home/ds332a/rover_code/src/rover_pkg/src/image_captures/%s.JPEG'%fileName)
				captureImageMode = 0
